...
# Этого мусора в библиотеке не должно быть. Библиотека должна содержать только функционал и константные данные, которые нужны в расчетах.
# Для проверок такой код нужно поместить в importing_libraries.py например
